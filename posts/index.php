 ...
 */
    ...
    try {
        ...
        $pur = new secureInput();
        $car = new categories('localhost', 'root', '', 'kel_local');
        ...
        if ((count($userd) > 0) || (count($userds)) && (!empty(@$search))) {
            echo'
             <div class="page-header">
                <h4 class="font_body" style="font-weight:normal !important;"><b>'.$search. '</b> news...</h4>
            </div>';
            echo'
                    <h4 hidden class="font_body" style="font-weight:normal !important;">Search results for <b>'.$search.'</b>...</h4>';
            //headline----
            ...
            foreach ($userd as $users) {
                ...
                echo '
                        <div class="body1 col-xs-12" >
                            <div class="col-xs-4"><img class="img-responsive img-body" alt="Image Loading..." style="max-height: 165px !important;" src="../imgs_body/'.$image.'"/></div>
            ...
            echo '</div>';
                ...
                echo '<div class="body1 col-xs-12" >
                                <div class="page-header">
