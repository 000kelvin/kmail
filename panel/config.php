...
$cfgDbDatabase = 'kely_users';        // MySQL database name containing phpSecurePages table
...
$cfgDbLocation = 'location';              // MySQL field name containing location
$cfgDbProfession = 'profession';            // MySQL field name containing location
$cfgDbRank = 'rank';                  // MySQL field name containing location
$cfgDbDate = 'date';                  // MySQL field name containing location
...
$cfgDbUserIDfield = 'primary_key';        // MySQL field name containing user identification
  ...
  // See readme.txt for more info.
$connections = mysqli_connect($cfgServerHost, $cfgServerUser, $cfgServerPassword, $cfgDbDatabase);
