...
$database_visitors = "kely_visitors";
$username_visitors = "root";
$password_visitors = "";

$visitors = mysqli_connect($hostname_visitors, $username_visitors, $password_visitors, $database_visitors) or trigger_error(mysqli_error(),E_USER_ERROR);
if(!$visitors)
	{
...
else if (preg_match('/Uc#([0-9].[0-9]{1,2})/', $HTTP_USER_AGENT, $log_version)) 
{ 
   $browser_version = $log_version[1]; 
   $browser_agent = 'Uc'; 
} 
