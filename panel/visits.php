...
<head>
    ...
    <title>Welcome to kelymail admin page...visits</title>
    ...
    <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-fw fa-automobile"></i> Visitors
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <table id="employee_grid" class="table table-condensed table-hover table-striped" width="100%" cellspacing="0" data-toggle="bootgrid">
            ...
            <tr>
                ...
                <th data-column-id="visitor_ip">IP</th>
                <th data-column-id="visitor_browser">Browser</th>
                <th data-column-id="visitor_minute">M</th>
                <th data-column-id="visitor_hour">H</th>

                <th data-column-id="visitor_day">D</th>
                <th data-column-id="visitor_month">Mo</th>
                <th data-column-id="visitor_year">Y</th>
                <th data-column-id="visitor_refferer">Referrer</th>
                <th data-column-id="visitor_page">Page of Visit</th>
            </tr>
            </thead>
        </table>
    </div>
