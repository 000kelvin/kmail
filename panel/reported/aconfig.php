...
$mysql_database = "kely_report";	//your mysql database

$bd = mysqli_connect($mysql_hostname, $mysql_user, $mysql_password, $mysql_database) or print("Opps some thing went wrong");
if(!$bd)
	{
		print("Connection failed: " . mysqli_connect_error());
	}
//mysqli_select_db($bd, $mysql_database) or print("Error on database connection");
